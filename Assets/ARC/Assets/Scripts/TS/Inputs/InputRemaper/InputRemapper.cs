...
namespace TS.Generics
{
    public class InputRemapper : MonoBehaviour
    {
            ...
            while (b_WaitForInputs)
            {
                ...
                if (returnKeyboardKeyCode() != KeyCode.None)
                {
                    ...
                    if (IsRemapInProcess && currentSelectedButton != TS_EventSystem.instance.eventSystem.currentSelectedGameObject ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse0) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse1) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse2) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse3) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse4) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse5) ||
                        ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse6))
                    {
        ...
        KeyCode returnKeyboardKeyCode()
        {
            ...
            { if (ControlFreak2.CF2Input.GetKeyDown(key)) { return key; } }
            return KeyCode.None;
            #endregion
        }
        ...
        string returnGamepadAxis(int whichPlayer)
        {
            ...
            for (var k = 0; k < Input.GetJoystickNames().Length; k++)
            {
                ...
                if (k < maxNumberOfGamepad)
                {
                    ...
                    for (var i = 0; i < 10; i++)
                    {
                        if (Mathf.Abs(ControlFreak2.CF2Input.GetAxisRaw("Joystick" + (k + 1).ToString() + "Axis" + (i + 1).ToString())) == 1)
                    ...
                    for (var i = 0; i < 20; i++)
                    {
                        if (Mathf.Abs(ControlFreak2.CF2Input.GetAxisRaw("Joystick" + (k + 1).ToString() + "Button" + (i).ToString())) == 1)
                        {
        ...
        {
            #region
            return ControlFreak2.CF2Input.GetAxisRaw(inputName);
            #endregion
        }
