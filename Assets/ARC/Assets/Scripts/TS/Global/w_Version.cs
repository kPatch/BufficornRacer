   ...
   void Version()
    {
        ...
        EditorGUILayout.LabelField("Version 1.0.3 for Unity 2021.1.21.");

        EditorGUILayout.LabelField("-[Correction] Championship result. Prevent the player to exit the championship without rewards.");
        EditorGUILayout.LabelField("-[Change] Disable anti-aliasing on Renderer Texture (Vehicle Selection).");
        ...
        EditorGUILayout.LabelField("-[script] (modification) Cam_Follow.cs");
        EditorGUILayout.LabelField("-[Optimisation] Remove Mask map on terrain");
        ...
        EditorGUILayout.LabelField("-[script] (modification) NewPUExample.cs");
