    ...
    public class VehicleInputs : MonoBehaviour
    {
        ...
        void TSInputSystemisNotUse()
        {
                ...
                !vehicleAI.enabled && vehicleInfo.playerNumber < howManyInputsAvailable)
            {
                ...
                {
                    // Up | Down
                     if (ControlFreak2.CF2Input.GetKey(keyDown))
                     {
                         if (DirDownGetKeyPressed != null)
                             DirDownGetKeyPressed?.Invoke();
                     }
                     else if (ControlFreak2.CF2Input.GetKey(keyUp))
                     {
                         if (DirUpGetKeyPressed != null)
                             DirUpGetKeyPressed?.Invoke();
                     }
                     else if (!ControlFreak2.CF2Input.GetKey(keyDown) && !ControlFreak2.CF2Input.GetKey(keyUp))
                     {
                     ...
                     // Left | Right
                     if (ControlFreak2.CF2Input.GetKey(keyLeft))
                     {
                         if (DirLeftGetKeyPressed != null)
                             DirLeftGetKeyPressed?.Invoke();
                     }
                     else if (ControlFreak2.CF2Input.GetKey(keyRight))
                     {
                         if (DirRightGetKeyPressed != null)
                             DirRightGetKeyPressed?.Invoke();
                     }
                     else if (!ControlFreak2.CF2Input.GetKey(keyLeft) && !ControlFreak2.CF2Input.GetKey(keyRight))
                     {
                     ...
                     // Acceleration
                     if (ControlFreak2.CF2Input.GetKey(keyDown) && !vehicleInfo.b_IsRespawn)
                     {
                    ...
                    // Booster keyBooster
                    if (ControlFreak2.CF2Input.GetKeyDown(keyBooster))
                    {
                        if (BoosterGetKeyPressed != null)
                            BoosterGetKeyPressed?.Invoke();
                    }
                    else if (ControlFreak2.CF2Input.GetKeyUp(keyBooster))
                    {
                    ...
                    if (ControlFreak2.CF2Input.GetKeyDown(keyPowerUps))
                    {
                        if (PowerUpGetKeyDown != null)
                            PowerUpGetKeyDown?.Invoke();
                    }
                    else if (ControlFreak2.CF2Input.GetKeyUp(keyPowerUps))
                    {
                    ...
                    if (ControlFreak2.CF2Input.GetKeyDown(keyCameraView))
                    {
